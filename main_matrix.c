...
int main (int argn, char **argc){
    int i,j,N[10],N_tilde,N_etapi,n,N_sin,n0,n1,n2,n0_sub,n1_sub,n2_sub;
    int N_M_int[4],N_M_avg[4],N_M_hat[2];
    double t,si,sf,ds,eps,eps_b,s_step,s,s0,L2,L2_tilde,L2_phase,s_min,s_max,k,s_step_low_high;
    double *s_cv_plus,*s_cv_minus,*s_below_cut,*phi,*s_tilde; //interpolation grid
    ...
    M_tilde_input(filename,M0_tilde,M1_tilde,M2_tilde,s_tilde,&N_M_hat[0],&N_M_hat[1],eps_b);
    printf("Done.\n\n");
    ...
    phase_shifts(delta0,delta1,delta2,sin_delta0,sin_delta1,sin_delta2,s_tilde,N_tilde);
    ...
    build_omnes(omnes0,abs_omnes0_dump,delta0,s0,L2_phase,2.*M_PI,s_cv_plus,s_cv_minus,s_below_cut,s_complex,N_M_int);
    build_omnes(omnes1,abs_omnes1_dump,delta1,s0,L2_phase,M_PI,s_cv_plus,s_cv_minus,s_below_cut,s_complex,N_M_int);
    build_omnes(omnes2,abs_omnes2_dump,delta2,s0,L2_phase,0.,s_cv_plus,s_cv_minus,s_below_cut,s_complex,N_M_int);
    
    abs_omnes_cv_plus(abs_omnes0,delta0,s0,L2_phase,2.*M_PI,s_tilde,N_tilde);
    ...
    build_inhomogenity_integrand_Matrix(M0_hat,M1_hat,M2_hat,F0,G0,F1,G1,F2,G2,M0_tilde,M1_tilde,M2_tilde,sin_delta0,sin_delta1,sin_delta2,abs_omnes0,abs_omnes1,abs_omnes2,s_tilde,s0,L2,N_M_hat,n0_sub,n1_sub,n2_sub);
    printf("Done.\n\n");
